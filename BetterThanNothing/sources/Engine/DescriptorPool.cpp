...
namespace BetterThanNothing
{
	...
	void DescriptorPool::CreateDescriptorPool(std::vector<Model*> pModels)
	{
		...
		poolSizes[1].descriptorCount = static_cast<uint32_t>(MAX_FRAMES_IN_FLIGHT * pModels.size()) * 2;
		...
		poolInfo.maxSets = static_cast<uint32_t>(MAX_FRAMES_IN_FLIGHT * pModels.size()) * 2;
